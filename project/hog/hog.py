...
def swine_align(player_score, opponent_score):
    ...
    if player_score == 0 or opponent_score == 0:
        ...
        for i in range(10, player_score + 1):
            if player_score % i == 0 and opponent_score % i == 0:
                return True
    return False
    # END PROBLEM 4a

# def calc_gcd(player_score, opponent_score):
#     ans = min(player_score, opponent_score)
#     while ans >= 1:
#         if player_score % ans == 0 and opponent_score % ans == 0:
#             return ans
#         ans -= 1
    ...
    def say(score0, score1):
        if who == 0:
            ...
            if this_increase > running_high:
                print("{} point(s)! The most yet for Player {}".format(this_increase, who))
